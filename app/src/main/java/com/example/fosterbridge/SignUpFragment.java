...
public class SignUpFragment extends Fragment {
    ...
    private void navigateToLoginFragment() {
        ...
        Fragment loginPageFragment = new LoginPageFragment(); // Replace with the actual Login Fragment class
        FragmentTransaction transaction = requireActivity().getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.fragment_container, loginPageFragment); // Ensure 'fragment_container' matches your container ID
        transaction.commit();
    }
}
